...
<html lang="en">
    <head>
        <title>RS&I Training | Login</title>
        <meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate, max-age=0">
        <meta http-equiv="Pragma" content="no-cache">
        <meta http-equiv="Expires" content="0">
        <meta charset="UTF-8">
        <meta name="description" content="RS&I Training Login">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="https://use.typekit.net/mbs4iof.css">
        <link rel="stylesheet" href="/home/css/marketing-portal_240603.min.css">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css"
            integrity="sha512-MV7K8+y+gLIBoVD59lQIYicR65iaqukzvf/nwasF0nqhPay5w/9lJmVM2hMDcnK1OnMGCdVK+iQrJ7lzPJQd1w=="
            crossorigin="anonymous" referrerpolicy="no-referrer">
        <link rel="stylesheet" href="/includes/css/uidLogin.min.css">
    </head>
<body id="RSI_LMS_login" class="rsi-lms-login">

    <header>
        <a href="/Home/index.asp">
            <img src="/home/images/RSI/logos/RSI_Blue.png" alt="RS&I Logo" height="59" width="91">
        </a>
    </header>

    <section>
        <div class="login-container">
            <h1>RS&amp;I Training Login</h1>
            
            <form id="login_form" class="login-form">
                <div class="form-group">
                    <label for="email">
                        Email Address <span class="required" title="Indicates a required field">*</span>
                        <p class="login-hint">Please use your email address associated with your dealer or RS&amp;I account.</p>
                    </label>
                    <input type="email" id="email" name="email" required pattern="^[^\s@]+@[^\s@]+\.[^\s@]+$" autofocus
                        title="Please use your email address associated with your dealer or RS&amp;I account.">
                    <input type="hidden" id="_fN9c2mqx" value="UapWqCmzR9PB0AU9VVmrnFFrJL6QwpACGwobW7lSK9U=">
                </div>

                <button id="LMS_Login_Button" type="submit" class="btn btn-lt-blue">Log In</button>
            </form>
    ...
    <footer>
        <div class="top flex flex-between">
            <div>
                ...
                RS&amp;I Corporate Toll Free Phone Number: <strong><a href="tel:+18008257999">1.800.825.7999</a></strong><br>
    ...
    <script src="/includes/modules/login.js" type="module"></script>
